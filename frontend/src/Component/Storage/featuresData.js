    ...
    items: [
      {
        ...
        desc: "Bulk storage for grains and other products.",
        action: "Book Storage",
      },
      {
        id: 2,
        ...
        desc: "Cold storage with humidity & temperature control.",
        action: "Learn More",
      },
      {
        id: 3,
        ...
        desc: "Protects crops from pests, moisture, and spoilage.",
        action: "See Details",
      },
      {
        id: 4,
        icon: "Warehouse",
        title: "Organic Storage",
        desc: "Eco-friendly storage options for sustainable produce.",
        action: "Learn More",
      },
    ],
  },
