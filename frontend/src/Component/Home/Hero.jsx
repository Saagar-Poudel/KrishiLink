      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <p className="text-green-500 text-lg md:text-xl max-w-lg text-left">
            ...
            <p className="text-gray-500 text-lg md:text-xl max-w-lg text-left">
        ...
        <div className="lg:w-1/2 relative">
          <div className="relative">
            ...
            <div className="flex flex-inline ">
              <div className="absolute top-10 right-0 bg-gray-300 rounded-xl p-3 shadow-lg border border-gray-100">
              ...
              <div className="absolute bottom-10 right-0 bg-gray-300 rounded-xl p-3 shadow-lg border border-gray-100">
                <div className="text-center">
                  <img
                    src="https://t3.ftcdn.net/jpg/05/99/17/38/360_F_599173818_kPdvAOH3vCp3ckyAy8bfu2mpfQtsB1QO.jpg"
                    alt="Fresh Carrot"
  ...
  <Categories/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-gray-600">Explore our range of fresh fruits</p>
        </div>

        <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow  ">
          <h2 className="font-bold text-xl mb-2 text-green-800">Vegetables</h2>
          <p className="text-gray-600">Farm fresh vegetables delivered daily</p>
        </div>
       ...
       <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-4">Modern Technology</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-4">Increased Productivity</h3>
            <p className="text-muted-foreground">
